...
const { classifyDocumentPath, detectProjectSectionCode, hasToken, isTransientSystemFile } = require('../src/lib/document-classifier') as typeof import('../src/lib/document-classifier')
