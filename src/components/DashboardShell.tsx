...
export default function DashboardShell({ children, userId, ...sidebar }: Props) {
	...
	// Сама настройка теперь живёт в Настройках (TableDensityToggle); здесь только
	// читаем сохранённое значение при заходе на страницу и держим атрибут в актуальном виде.
