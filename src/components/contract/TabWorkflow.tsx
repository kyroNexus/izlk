	...
	return (
		<Card id="workflow" role="tabpanel" aria-labelledby="tab-workflow">
			...
			<div className="p-[18px]">
				...
				{isAdminUser && contract.pr1ConfirmedAt && <form action={revokePr1} className="mt-[12px] flex flex-wrap items-center gap-[8px] border-t border-line-soft pt-[12px]"><span className="text-[11.5px] text-faint">Админ: отмена ошибочного ПР1</span><input name="reason" required placeholder="Причина отмены" className="h-[34px] min-w-[180px] flex-1 rounded-[8px] border border-danger/25 bg-surface px-[9px] text-[12px]" /><button className="h-[34px] rounded-[8px] border border-danger/30 bg-danger/10 px-[11px] text-[12px] font-semibold text-danger">Отменить ПР1</button></form>}
