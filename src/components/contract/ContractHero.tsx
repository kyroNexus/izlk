		...
		<div className="work-hero mb-[20px] flex flex-col gap-4 px-5 py-4 sm:flex-row sm:items-start">
			...
			{canEdit && (
				<div className="flex flex-wrap gap-[9px] sm:ml-auto sm:justify-end">
					...
					{isAdminUser && <form action={deleteContract}><button className="inline-flex h-[38px] items-center rounded-[10px] border border-danger/25 bg-danger/10 px-[12px] text-[12px] font-semibold text-danger hover:bg-danger/15">В корзину</button></form>}
				</div>
			)}
		</div>
	)
