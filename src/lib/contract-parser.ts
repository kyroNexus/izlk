...
const FOLDER_CATEGORIES = [
	{ key: 'source-data', label: 'Исходные данные заказчика', expression: /(?:\bиги\b|инженерн(?:о|ые)[ -]?геолог|\bгпзу\b|градостроительн|топос[ъь]ем|топограф|стеснен|исходн(?:ые)?[ -]?данн)/i },
