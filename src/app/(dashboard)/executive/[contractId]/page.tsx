...
export default async function ExecutiveContractPage({ params }: { params: { contractId: string } }) {
	...
	async function initialize() {
		'use server'
		const acting = await requireUser(); if (!canWrite(acting)) redirect(`/executive/${params.contractId}`)
