...
export default async function SitePage({ params }: { params: { id: string } }) {
	...
	return <><Topbar crumbs={[{ label: 'Главная', href: '/' }, { label: 'Площадки', href: '/sites' }, { label: site.address }]} userName={name.split(' ')[0]} initials={initials(name)} /><div className="workspace-content">
